...
<html>
    ...
    <body>
        <div class="jumbotron" style="background-color: lightskyblue">
            <h1>Membership Director Results</h1>
        </div>
        <div class="container" style="background-color: white">
             <ol class="breadcrumb">
                <li><a href="home.php">Home</a></li>
                <li><a href="elections.php">Elections</a>
                <li class="active">Membership Results</li>
            </ol>
           ...
           <div class="row">
                <div class="col-sm-9">
                    ...
                    $sql = "SELECT vote, Count(vote) FROM `ElectionsVotes` WHERE position = 'membership' GROUP BY vote";
